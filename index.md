# 特許・技術
##A. 歌詞・音節・フレーズ制御（基本特許群）    「歌詞を“演奏可能なパラメータ”として扱う」核    基本特許（フレーズモード等）
...
##B. 抑揚・音高・ピッチ表現制御（歌い方）      「どう歌うか」を制御する表現系                派生特許（ラップ等）
...
##C. 励振源・音源構造（ポリ／外部励振）        「歌声DSPをどう使うか」構造系                派生特許（ポリモード/外部励振源）
...
##D. UI・演奏操作・リアルタイム制御            「弾いて操作できる歌声」                    派生特許（楽器向け要素技術）
...
##E. 応用・派生・統合（用途展開）              「商品化・展開を意識した派生」                派生特許（将来向け）
